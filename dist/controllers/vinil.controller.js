...
exports.updateVinil = exports.createVinil = exports.getVinisNomes = exports.getVinis = void 0;
const cosmos_1 = require("../config/cosmos");
const uuid_1 = require("uuid");
const getVinis = async (req, res) => {
    try {
...
exports.getVinis = getVinis;
const getVinisNomes = async (req, res) => {
    try {
        const container = await (0, cosmos_1.getContainer)();
        const { resources } = await container.items
...
exports.getVinisNomes = getVinisNomes;
const createVinil = async (req, res) => {
    try {
        const { type, title, author, recordLabel, country, year, description, tracksA, tracksB, image, backImage, insertImage, quantity, recordImage, exemplarImages, revised } = req.body;
        if (!title || !author) {
...
exports.createVinil = createVinil;
const updateVinil = async (req, res) => {
    try {
        const { id } = req.params;
        const { type, title, author, recordLabel, country, year, description, tracksA, tracksB, image, backImage, insertImage, quantity, recordImage, exemplarImages, revised } = req.body;
        const container = await (0, cosmos_1.getContainer)();
...
exports.updateVinil = updateVinil;
