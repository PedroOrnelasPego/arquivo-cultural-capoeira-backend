...
const vinil_controller_1 = require("../controllers/vinil.controller");
 ...
 */
router.get('/', vinil_controller_1.getVinis);
/**
 * @swagger
 * /api/vinis/nomes:
 *   get:
 ...
 *         description: Erro no Servidor
 */
router.get('/nomes', vinil_controller_1.getVinisNomes);
/**
 * @swagger
 * /api/vinis:
 *   post:
 ...
 */
router.post('/', vinil_controller_1.createVinil);
/**
 * @swagger
 * /api/vinis/{id}:
 *   put:
 ...
 */
router.put('/:id', vinil_controller_1.updateVinil);
